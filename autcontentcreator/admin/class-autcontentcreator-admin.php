...
class Autcontentcreator_Admin {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/autcontentcreator-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/autcontentcreator-admin.js', array( 'jquery' ), $this->version, false );
	...
	public function admin_content_creator_page() {
    	...
    	array($this, 'auto_content_creation') ,'dashicons-welcome-write-blog',3 );	
	}
